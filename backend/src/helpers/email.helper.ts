...
export class EmailHelper {
    ...
    static async sendResetPasswordEmail(email: string, otpPasscode: string): Promise<boolean> {
        const otpMessage = `
            <p>Thank you for using My TMDB-Movie Application. Your OTP code to reset password is:</p>
            <h2>${otpPasscode}</h2>
